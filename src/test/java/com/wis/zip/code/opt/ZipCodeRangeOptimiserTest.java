...
public class ZipCodeRangeOptimiserTest {
	...
	private ZipCodeRangeOptimiserImpl codeRangeOptimiser;

	@Before
	public void setup() {
		codeRangeOptimiser = new ZipCodeRangeOptimiserImpl();
	}

	@Test
	public void testGetOptimizeZipBoundary1() throws ZipCodeServiceException {
		String optimizedZipcodeBoundaries = codeRangeOptimiser
				.getOptimizeZipBoundary("[94133,94133][94200,94299][94600,94699]");
	...
	public void testGetOptimizeZipBoundary2() throws ZipCodeServiceException {
		String optimizedZipcodeBoundaries = codeRangeOptimiser
				.getOptimizeZipBoundary("[94133,94133][94200,94299][94226,94399]");
	...
	public void testGetOptimizeZipBoundary3() throws ZipCodeServiceException {
		String optimizedZipcodeBoundaries = codeRangeOptimiser.getOptimizeZipBoundary(
